...
namespace MyVet.Web.Data
{
    public class SeedDb    {
            ...
            public async Task SeedAsync()
            {
                ...
                await CheckRoles();
                var manager = await CheckUserAsync("1010", "José", "Edet", "joseedet@gmail.com", "692464538", "Calle Cartagena, 294 3º 1ª", "Admin");
                var customer = await CheckUserAsync("2020", "José", "Edet", "jschneiderligero@yahoo.es", "692464538", "Calle Cartagena, 294 3º 1ª", "Customer");
